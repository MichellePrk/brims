# Study and Assay Data Management
...
- Study coordinators
- Laboratory staff involved in assay workflows
- Data managers
...
You can also record a public release date where that helps your study tracking.
...
In the current UI, use the study's **Specimens** section to:

- Attach specimens directly
- Import specimen lists
- Export the study specimen set
...
In the current BRIMS UI, assay definitions are managed at the **team** level and reused when study-level assays are created.
